...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Size = System::Drawing::Size(619, 66);
			...
			// tbName
			// 
			this->tbName->Location = System::Drawing::Point(268, 91);
			this->tbName->Name = L"tbName";
			this->tbName->Size = System::Drawing::Size(364, 31);
			...
			// tbEmail
			// 
			this->tbEmail->Location = System::Drawing::Point(268, 128);
			this->tbEmail->Name = L"tbEmail";
			this->tbEmail->Size = System::Drawing::Size(364, 31);
			this->tbEmail->TabIndex = 2;
			// 
			// label4
			// 
			this->label4->AutoSize = true;
			this->label4->Location = System::Drawing::Point(20, 165);
			...
			// tbPhone
			// 
			this->tbPhone->Location = System::Drawing::Point(268, 165);
			this->tbPhone->Name = L"tbPhone";
			this->tbPhone->Size = System::Drawing::Size(364, 31);
			this->tbPhone->TabIndex = 2;
			// 
			// label5
			// 
			this->label5->AutoSize = true;
			this->label5->Location = System::Drawing::Point(20, 202);
			...
			// tbAddress
			// 
			this->tbAddress->Location = System::Drawing::Point(268, 202);
			this->tbAddress->Name = L"tbAddress";
			this->tbAddress->Size = System::Drawing::Size(364, 31);
			this->tbAddress->TabIndex = 2;
			// 
			// label6
			// 
			this->label6->AutoSize = true;
			this->label6->Location = System::Drawing::Point(20, 239);
			...
			// tbPassword
			// 
			this->tbPassword->Location = System::Drawing::Point(268, 239);
			this->tbPassword->Name = L"tbPassword";
			this->tbPassword->PasswordChar = '*';
			this->tbPassword->Size = System::Drawing::Size(364, 31);
			this->tbPassword->TabIndex = 2;
			// 
			// label7
			// 
			this->label7->AutoSize = true;
			this->label7->Location = System::Drawing::Point(20, 276);
			...
			// tbConfirmPassword
			// 
			this->tbConfirmPassword->Location = System::Drawing::Point(268, 276);
			this->tbConfirmPassword->Name = L"tbConfirmPassword";
			this->tbConfirmPassword->PasswordChar = '*';
			this->tbConfirmPassword->Size = System::Drawing::Size(364, 31);
			this->tbConfirmPassword->TabIndex = 2;
			// 
			// btnOK
			// 
			this->btnOK->Location = System::Drawing::Point(268, 339);
			this->btnOK->Name = L"btnOK";
			this->btnOK->Size = System::Drawing::Size(181, 40);
			...
			// btnCancel
			// 
			this->btnCancel->Location = System::Drawing::Point(455, 339);
			this->btnCancel->Name = L"btnCancel";
			this->btnCancel->Size = System::Drawing::Size(177, 40);
			...
			this->llLogin->Location = System::Drawing::Point(567, 393);
...
#pragma endregion
	...
	private: System::Void btnOK_Click(System::Object^ sender, System::EventArgs^ e) 
	{
		...
		try {
			String^ connString = "Data Source=localhost\\sqlexpress;Initial Catalog=project3db;Integrated Security=True";
